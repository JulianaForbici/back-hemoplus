 ...
 * 
 */
public class BuscarUsuarioCloudImpl {
	...
	public BuscarUsuarioCloudImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(BuscarUsuarioCloudInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.BUSCAR_USUARIO_CLOUD, //
	...
	*/
	public BuscarUsuarioCloudOutput buscarUsuarioCloud(BuscarUsuarioCloudInput input, long timeout) {
		...
		BuscarUsuarioCloudOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), BuscarUsuarioCloudOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<BuscarUsuarioCloudOutput> buscarUsuarioCloudRequest(BuscarUsuarioCloudInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, BuscarUsuarioCloudOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<BuscarUsuarioCloudOutput> buscarUsuarioCloudRequest(BuscarUsuarioCloudInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, BuscarUsuarioCloudOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
