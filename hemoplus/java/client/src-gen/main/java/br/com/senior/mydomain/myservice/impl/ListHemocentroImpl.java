 ...
 * 
 */
public class ListHemocentroImpl {
	...
	public ListHemocentroImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Hemocentro.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.LIST_HEMOCENTRO, //
	...
	*/
	public Hemocentro.PagedResults listHemocentro(Hemocentro.PageRequest input, long timeout) {
		...
		Hemocentro.PagedResults output = DtoJsonConverter.toDTO(resultMessage.getContent(), Hemocentro.PagedResults.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<Hemocentro.PagedResults> listHemocentroRequest(Hemocentro.PageRequest input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Hemocentro.PagedResults.class);
	}
	...
	* The 'list' request primitive for the Hemocentro entity.
	*/
	public CompletableFuture<Hemocentro.PagedResults> listHemocentroRequest(Hemocentro.PageRequest input, long timeout, TimeUnit unit) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Hemocentro.PagedResults.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
