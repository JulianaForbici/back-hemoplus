 ...
 * 
 */
public class CreateMergeUsuarioImpl {
	...
	public CreateMergeUsuarioImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Usuario input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_MERGE_USUARIO, //
	...
	* The 'createMerge' request primitive for the Usuario entity.
	*/
	public CompletableFuture<Usuario> createMergeUsuarioRequest(Usuario input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
