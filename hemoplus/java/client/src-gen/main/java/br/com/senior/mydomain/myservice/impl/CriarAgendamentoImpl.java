...
import br.com.senior.mydomain.myservice.CriarAgendamentoInput;
import br.com.senior.mydomain.myservice.CriarAgendamentoOutput;
 ...
 * 
 */
public class CriarAgendamentoImpl {
	...
	public CriarAgendamentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CriarAgendamentoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CRIAR_AGENDAMENTO, //
	...
	*/
	public CriarAgendamentoOutput criarAgendamento(CriarAgendamentoInput input, long timeout) {
		...
		CriarAgendamentoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CriarAgendamentoOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<CriarAgendamentoOutput> criarAgendamentoRequest(CriarAgendamentoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CriarAgendamentoOutput.class);
	}
	...
	* actions de agendamento
	*/
	public CompletableFuture<CriarAgendamentoOutput> criarAgendamentoRequest(CriarAgendamentoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CriarAgendamentoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
