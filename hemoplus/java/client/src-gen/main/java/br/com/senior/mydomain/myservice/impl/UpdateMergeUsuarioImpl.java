 ...
 * 
 */
public class UpdateMergeUsuarioImpl {
	...
	public UpdateMergeUsuarioImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Usuario input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MERGE_USUARIO, //
	...
	* The 'updateMerge' request primitive for the Usuario entity.
	*/
	public CompletableFuture<Usuario> updateMergeUsuarioRequest(Usuario input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
