 ...
 * 
 */
public class ListarPontosMapaImpl {
	...
	public ListarPontosMapaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ListarPontosMapaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.LISTAR_PONTOS_MAPA, //
	...
	*/
	public ListarPontosMapaOutput listarPontosMapa(ListarPontosMapaInput input, long timeout) {
		...
		ListarPontosMapaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ListarPontosMapaOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<ListarPontosMapaOutput> listarPontosMapaRequest(ListarPontosMapaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ListarPontosMapaOutput.class);
	}
	...
	* queries de mapa e usuario
	*/
	public CompletableFuture<ListarPontosMapaOutput> listarPontosMapaRequest(ListarPontosMapaInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ListarPontosMapaOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
