 ...
 * 
 */
public class RetrieveHemocentroImpl {
	...
	public RetrieveHemocentroImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Hemocentro.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.RETRIEVE_HEMOCENTRO, //
	...
	*/
	public Hemocentro retrieveHemocentro(Hemocentro.GetRequest input, long timeout) {
		...
		Hemocentro output = DtoJsonConverter.toDTO(resultMessage.getContent(), Hemocentro.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<Hemocentro> retrieveHemocentroRequest(Hemocentro.GetRequest input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Hemocentro.class);
	}
	...
	* The 'retrieve' request primitive for the Hemocentro entity.
	*/
	public CompletableFuture<Hemocentro> retrieveHemocentroRequest(Hemocentro.GetRequest input, long timeout, TimeUnit unit) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Hemocentro.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
