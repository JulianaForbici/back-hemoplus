 ...
 * 
 */
public class UpdateEstoqueImpl {
	...
	public UpdateEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Estoque input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_ESTOQUE, //
	...
	* The 'update' request primitive for the Estoque entity.
	*/
	public CompletableFuture<Estoque> updateEstoqueRequest(Estoque input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
