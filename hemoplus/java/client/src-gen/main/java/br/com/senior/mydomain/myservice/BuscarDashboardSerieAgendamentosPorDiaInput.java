...
public class BuscarDashboardSerieAgendamentosPorDiaInput {
    ...
    public BuscarDashboardSerieAgendamentosPorDiaInput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public BuscarDashboardSerieAgendamentosPorDiaInput(java.time.Instant dataInicio, java.time.Instant dataFim, String hemocentroId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BuscarDashboardSerieAgendamentosPorDiaInput)) {
            return false;
        }
        BuscarDashboardSerieAgendamentosPorDiaInput other = (BuscarDashboardSerieAgendamentosPorDiaInput) obj;
    ...
    public void toString(StringBuilder sb, List<Object> appended) {
    	BuscarDashboardSerieAgendamentosPorDiaInputStringSerializer.INSTANCE.serialize(this, sb, appended);
    }
