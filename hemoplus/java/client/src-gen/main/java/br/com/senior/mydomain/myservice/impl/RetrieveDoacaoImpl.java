 ...
 * 
 */
public class RetrieveDoacaoImpl {
	...
	public RetrieveDoacaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Doacao.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.RETRIEVE_DOACAO, //
	...
	* The 'retrieve' request primitive for the Doacao entity.
	*/
	public CompletableFuture<Doacao> retrieveDoacaoRequest(Doacao.GetRequest input, long timeout, TimeUnit unit) {
