 ...
 * 
 */
public class UpdateMergeHemocentroImpl {
	...
	public UpdateMergeHemocentroImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Hemocentro input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.UPDATE_MERGE_HEMOCENTRO, //
	...
	* The 'updateMerge' request primitive for the Hemocentro entity.
	*/
	public CompletableFuture<Hemocentro> updateMergeHemocentroRequest(Hemocentro input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
