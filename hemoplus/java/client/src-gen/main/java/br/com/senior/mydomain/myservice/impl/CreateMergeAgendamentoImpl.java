 ...
 * 
 */
public class CreateMergeAgendamentoImpl {
	...
	public CreateMergeAgendamentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Agendamento input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_MERGE_AGENDAMENTO, //
	...
	* The 'createMerge' request primitive for the Agendamento entity.
	*/
	public CompletableFuture<Agendamento> createMergeAgendamentoRequest(Agendamento input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
