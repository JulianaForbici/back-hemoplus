 ...
 * 
 */
public class UpdateMergeDoacaoImpl {
	...
	public UpdateMergeDoacaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Doacao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MERGE_DOACAO, //
	...
	* The 'updateMerge' request primitive for the Doacao entity.
	*/
	public CompletableFuture<Doacao> updateMergeDoacaoRequest(Doacao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
