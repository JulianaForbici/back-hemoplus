 ...
 * 
 */
public class CreateMergeDoacaoImpl {
	...
	public CreateMergeDoacaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Doacao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_MERGE_DOACAO, //
	...
	* The 'createMerge' request primitive for the Doacao entity.
	*/
	public CompletableFuture<Doacao> createMergeDoacaoRequest(Doacao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
