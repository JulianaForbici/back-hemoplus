...
public class ListDoacaoImpl {
	...
	public ListDoacaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Doacao.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.LIST_DOACAO, //
	...
	* The 'list' request primitive for the Doacao entity.
	*/
	public CompletableFuture<Doacao.PagedResults> listDoacaoRequest(Doacao.PageRequest input, long timeout, TimeUnit unit) {
