...
import br.com.senior.mydomain.myservice.ListarTiposEmFaltaInput;
import br.com.senior.mydomain.myservice.ListarTiposEmFaltaOutput;
 ...
 * 
 */
public class ListarTiposEmFaltaImpl {
	...
	public ListarTiposEmFaltaImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ListarTiposEmFaltaInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.LISTAR_TIPOS_EM_FALTA, //
	...
	*/
	public ListarTiposEmFaltaOutput listarTiposEmFalta(ListarTiposEmFaltaInput input, long timeout) {
		...
		ListarTiposEmFaltaOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ListarTiposEmFaltaOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<ListarTiposEmFaltaOutput> listarTiposEmFaltaRequest(ListarTiposEmFaltaInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ListarTiposEmFaltaOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<ListarTiposEmFaltaOutput> listarTiposEmFaltaRequest(ListarTiposEmFaltaInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ListarTiposEmFaltaOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
