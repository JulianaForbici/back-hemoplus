 ...
 * 
 */
public class CreateAgendamento_DoacoesImpl {
	...
	public CreateAgendamento_DoacoesImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Doacao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_AGENDAMENTO_DOACOES, //
	...
	* The 'create' request primitive for the doacoes attribute of agendamento entity.\nThis primitive requires the header 'entity_parent_id' with id of parent agendamento entity.
	*/
	public CompletableFuture<Doacao> createAgendamento_DoacoesRequest(Agendamento.Id parentId, Doacao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
