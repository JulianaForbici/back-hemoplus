 ...
 * 
 */
public class CreateMergeEstoqueImpl {
	...
	public CreateMergeEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Estoque input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_MERGE_ESTOQUE, //
	...
	* The 'createMerge' request primitive for the Estoque entity.
	*/
	public CompletableFuture<Estoque> createMergeEstoqueRequest(Estoque input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
