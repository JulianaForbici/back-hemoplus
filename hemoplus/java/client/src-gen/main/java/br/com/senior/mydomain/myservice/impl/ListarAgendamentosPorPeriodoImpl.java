 ...
 * 
 */
public class ListarAgendamentosPorPeriodoImpl {
	...
	public ListarAgendamentosPorPeriodoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ListarAgendamentosPorPeriodoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.LISTAR_AGENDAMENTOS_POR_PERIODO, //
	...
	*/
	public ListarAgendamentosPorPeriodoOutput listarAgendamentosPorPeriodo(ListarAgendamentosPorPeriodoInput input, long timeout) {
		...
		ListarAgendamentosPorPeriodoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ListarAgendamentosPorPeriodoOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<ListarAgendamentosPorPeriodoOutput> listarAgendamentosPorPeriodoRequest(ListarAgendamentosPorPeriodoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ListarAgendamentosPorPeriodoOutput.class);
	}
	...
	* queries de agendamento
	*/
	public CompletableFuture<ListarAgendamentosPorPeriodoOutput> listarAgendamentosPorPeriodoRequest(ListarAgendamentosPorPeriodoInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ListarAgendamentosPorPeriodoOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
