 ...
 * 
 */
public class ListAgendamentoImpl {
	...
	public ListAgendamentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Agendamento.PageRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.LIST_AGENDAMENTO, //
	...
	* The 'list' request primitive for the Agendamento entity.
	*/
	public CompletableFuture<Agendamento.PagedResults> listAgendamentoRequest(Agendamento.PageRequest input, long timeout, TimeUnit unit) {
