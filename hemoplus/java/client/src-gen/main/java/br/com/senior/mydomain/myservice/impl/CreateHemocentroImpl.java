 ...
 * 
 */
public class CreateHemocentroImpl {
	...
	public CreateHemocentroImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Hemocentro input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_HEMOCENTRO, //
	...
	* The 'create' request primitive for the Hemocentro entity.
	*/
	public CompletableFuture<Hemocentro> createHemocentroRequest(Hemocentro input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
