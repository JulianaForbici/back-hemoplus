 ...
 * 
 */
public class CreateEstoqueImpl {
	...
	public CreateEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Estoque input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_ESTOQUE, //
	...
	* The 'create' request primitive for the Estoque entity.
	*/
	public CompletableFuture<Estoque> createEstoqueRequest(Estoque input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
