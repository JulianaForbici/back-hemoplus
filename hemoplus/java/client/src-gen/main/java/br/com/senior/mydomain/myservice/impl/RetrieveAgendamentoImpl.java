 ...
 * 
 */
public class RetrieveAgendamentoImpl {
	...
	public RetrieveAgendamentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Agendamento.GetRequest input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.RETRIEVE_AGENDAMENTO, //
	...
	* The 'retrieve' request primitive for the Agendamento entity.
	*/
	public CompletableFuture<Agendamento> retrieveAgendamentoRequest(Agendamento.GetRequest input, long timeout, TimeUnit unit) {
