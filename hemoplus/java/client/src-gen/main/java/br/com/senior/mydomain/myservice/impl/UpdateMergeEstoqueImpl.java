 ...
 * 
 */
public class UpdateMergeEstoqueImpl {
	...
	public UpdateMergeEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Estoque input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MERGE_ESTOQUE, //
	...
	* The 'updateMerge' request primitive for the Estoque entity.
	*/
	public CompletableFuture<Estoque> updateMergeEstoqueRequest(Estoque input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
