...
public class CreateDoacaoImpl {
	...
	public CreateDoacaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Doacao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_DOACAO, //
	...
	* The 'create' request primitive for the Doacao entity.
	*/
	public CompletableFuture<Doacao> createDoacaoRequest(Doacao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
