 ...
 * 
 */
public class CreateUsuarioImpl {
	...
	public CreateUsuarioImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Usuario input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_USUARIO, //
	...
	* The 'create' request primitive for the Usuario entity.
	*/
	public CompletableFuture<Usuario> createUsuarioRequest(Usuario input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
