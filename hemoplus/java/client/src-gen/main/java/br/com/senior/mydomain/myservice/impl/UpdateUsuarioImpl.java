 ...
 * 
 */
public class UpdateUsuarioImpl {
	...
	public UpdateUsuarioImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Usuario input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_USUARIO, //
	...
	* The 'update' request primitive for the Usuario entity.
	*/
	public CompletableFuture<Usuario> updateUsuarioRequest(Usuario input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
