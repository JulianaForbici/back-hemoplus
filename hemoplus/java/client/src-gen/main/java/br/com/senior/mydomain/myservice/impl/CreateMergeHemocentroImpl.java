 ...
 * 
 */
public class CreateMergeHemocentroImpl {
	...
	public CreateMergeHemocentroImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Hemocentro input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_MERGE_HEMOCENTRO, //
	...
	* The 'createMerge' request primitive for the Hemocentro entity.
	*/
	public CompletableFuture<Hemocentro> createMergeHemocentroRequest(Hemocentro input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
