 ...
 * 
 */
public class BuscarDashboardResumoAgendamentosImpl {
	...
	public BuscarDashboardResumoAgendamentosImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(BuscarDashboardResumoAgendamentosInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.BUSCAR_DASHBOARD_RESUMO_AGENDAMENTOS, //
	...
	*/
	public BuscarDashboardResumoAgendamentosOutput buscarDashboardResumoAgendamentos(BuscarDashboardResumoAgendamentosInput input, long timeout) {
		...
		BuscarDashboardResumoAgendamentosOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), BuscarDashboardResumoAgendamentosOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<BuscarDashboardResumoAgendamentosOutput> buscarDashboardResumoAgendamentosRequest(BuscarDashboardResumoAgendamentosInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, BuscarDashboardResumoAgendamentosOutput.class);
	}
	...
	* queries de dashboard
	*/
	public CompletableFuture<BuscarDashboardResumoAgendamentosOutput> buscarDashboardResumoAgendamentosRequest(BuscarDashboardResumoAgendamentosInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, BuscarDashboardResumoAgendamentosOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
