 ...
 * 
 */
public class UpdateMergeAgendamentoImpl {
	...
	public UpdateMergeAgendamentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Agendamento input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_MERGE_AGENDAMENTO, //
	...
	* The 'updateMerge' request primitive for the Agendamento entity.
	*/
	public CompletableFuture<Agendamento> updateMergeAgendamentoRequest(Agendamento input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
