 ...
 * 
 */
public class CreateUsuario_AgendamentosImpl {
	...
	public CreateUsuario_AgendamentosImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Agendamento input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_USUARIO_AGENDAMENTOS, //
	...
	* The 'create' request primitive for the agendamentos attribute of usuario entity.\nThis primitive requires the header 'entity_parent_id' with id of parent usuario entity.
	*/
	public CompletableFuture<Agendamento> createUsuario_AgendamentosRequest(Usuario.Id parentId, Agendamento input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
