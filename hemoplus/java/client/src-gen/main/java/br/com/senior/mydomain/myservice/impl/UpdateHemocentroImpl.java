 ...
 * 
 */
public class UpdateHemocentroImpl {
	...
	public UpdateHemocentroImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Hemocentro input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_HEMOCENTRO, //
	...
	* The 'update' request primitive for the Hemocentro entity.
	*/
	public CompletableFuture<Hemocentro> updateHemocentroRequest(Hemocentro input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
