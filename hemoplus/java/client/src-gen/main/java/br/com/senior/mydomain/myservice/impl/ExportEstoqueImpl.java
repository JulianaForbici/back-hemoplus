...
import br.com.senior.mydomain.myservice.ExportEstoqueInput;
import br.com.senior.mydomain.myservice.ExportEstoqueOutput;
 ...
 * 
 */
public class ExportEstoqueImpl {
	...
	public ExportEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportEstoqueInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.EXPORT_ESTOQUE, //
	...
	*/
	public ExportEstoqueOutput exportEstoque(ExportEstoqueInput input, long timeout) {
		...
		ExportEstoqueOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportEstoqueOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<ExportEstoqueOutput> exportEstoqueRequest(ExportEstoqueInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportEstoqueOutput.class);
	}
	...
	* 
	*/
	public CompletableFuture<ExportEstoqueOutput> exportEstoqueRequest(ExportEstoqueInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportEstoqueOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
