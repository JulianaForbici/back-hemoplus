...
public class UpdateDoacaoImpl {
	...
	public UpdateDoacaoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Doacao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_DOACAO, //
	...
	* The 'update' request primitive for the Doacao entity.
	*/
	public CompletableFuture<Doacao> updateDoacaoRequest(Doacao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
