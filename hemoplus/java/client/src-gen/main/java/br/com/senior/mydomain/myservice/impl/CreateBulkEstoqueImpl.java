...
import br.com.senior.mydomain.myservice.CreateBulkEstoqueInput;
import br.com.senior.mydomain.myservice.CreateBulkEstoqueOutput;
 ...
 * 
 */
public class CreateBulkEstoqueImpl {
	...
	public CreateBulkEstoqueImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkEstoqueInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_BULK_ESTOQUE, //
	...
	*/
	public CreateBulkEstoqueOutput createBulkEstoque(CreateBulkEstoqueInput input, long timeout) {
		...
		CreateBulkEstoqueOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkEstoqueOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<CreateBulkEstoqueOutput> createBulkEstoqueRequest(CreateBulkEstoqueInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkEstoqueOutput.class);
	}
	...
	* The 'createBulk' request primitive for the Estoque entity.
	*/
	public CompletableFuture<CreateBulkEstoqueOutput> createBulkEstoqueRequest(CreateBulkEstoqueInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkEstoqueOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
