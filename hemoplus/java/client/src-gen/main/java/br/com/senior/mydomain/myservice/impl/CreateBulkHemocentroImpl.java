...
import br.com.senior.mydomain.myservice.CreateBulkHemocentroInput;
import br.com.senior.mydomain.myservice.CreateBulkHemocentroOutput;
 ...
 * 
 */
public class CreateBulkHemocentroImpl {
	...
	public CreateBulkHemocentroImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkHemocentroInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				userId.getTenant(), //
				MyServiceConstants.DOMAIN, //
				MyServiceConstants.SERVICE, //
				MyServiceConstants.Commands.CREATE_BULK_HEMOCENTRO, //
	...
	*/
	public CreateBulkHemocentroOutput createBulkHemocentro(CreateBulkHemocentroInput input, long timeout) {
		...
		CreateBulkHemocentroOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkHemocentroOutput.class);
		if (output == null) {
	...
	*/
	...
	public CompletableFuture<CreateBulkHemocentroOutput> createBulkHemocentroRequest(CreateBulkHemocentroInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkHemocentroOutput.class);
	}
	...
	* The 'createBulk' request primitive for the Hemocentro entity.
	*/
	public CompletableFuture<CreateBulkHemocentroOutput> createBulkHemocentroRequest(CreateBulkHemocentroInput input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkHemocentroOutput.class, TimeUnit.MILLISECONDS.convert(timeout, unit));
	}
