 ...
 * 
 */
public class CreateMergeAgendamento_DoacoesImpl {
	...
	public CreateMergeAgendamento_DoacoesImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Doacao input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_MERGE_AGENDAMENTO_DOACOES, //
	...
	* The 'createMerge' request primitive for the doacoes attribute of agendamento entity.\nThis primitive requires the header 'entity_parent_id' with id of parent agendamento entity.
	*/
	public CompletableFuture<Doacao> createMergeAgendamento_DoacoesRequest(Agendamento.Id parentId, Doacao input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
