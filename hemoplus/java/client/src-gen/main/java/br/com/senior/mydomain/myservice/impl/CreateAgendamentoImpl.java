 ...
 * 
 */
public class CreateAgendamentoImpl {
	...
	public CreateAgendamentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Agendamento input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.CREATE_AGENDAMENTO, //
	...
	* The 'create' request primitive for the Agendamento entity.
	*/
	public CompletableFuture<Agendamento> createAgendamentoRequest(Agendamento input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
