 ...
 * 
 */
public class UpdateAgendamentoImpl {
	...
	public UpdateAgendamentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Agendamento input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				MyServiceConstants.Commands.UPDATE_AGENDAMENTO, //
	...
	* The 'update' request primitive for the Agendamento entity.
	*/
	public CompletableFuture<Agendamento> updateAgendamentoRequest(Agendamento input, long timeout, TimeUnit unit) {
		MyServiceValidator.validate(input);
